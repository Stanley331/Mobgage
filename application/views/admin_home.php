					...
					<div class="container_12">
						<div class="grid_12">
							<nav class="horizontal-nav full-width horizontalNav-notprocessed">
								<ul class="sf-menu">
									<li class="current"><a>AdminHome</a></li>
									<li><a href="http://localhost/RentBike_Sample/admin/mobgage_viewby_admin">View Mobile</a></li>
									<li><a href="http://localhost/RentBike_Sample/admin/leasers_viewby_admin">View Orders</a></li>
									<li><a href="http://localhost/RentBike_Sample/admin/customers_viewby_admin">View Customers</a></li>
									<li><a href="http://localhost/RentBike_Sample/admin/daily_report">Daily Report</a></li>
