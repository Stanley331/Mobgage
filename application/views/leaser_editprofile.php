    ...
    <div class="page-wrapper bg-gra-02 p-t-130 p-b-100 font-poppins">
        <div class="wrapper wrapper--w680">
            <div class="card card-4">
                <div class="card-body">
                    <h2 class="title">Leaser Profile Edit Form</h2>
                    <form action="leaser_editprofile_action.php" method="POST">
                            ...
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <div class="input-group-icon">
                                        <input class="input--style-4 js-datepicker" type="date" name="dob" value="<?php echo $dob;?>">
                        ...
                        <div class="row row-space">
                            ...
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <option disabled="disabled" selected="selected" ><?php echo $district;?></option>
                       ...
                       <div class="row row-space">
                            ...
                            <div class="col-2">
                                <div class="input-group">
                                     <select name="id_card">
                                    <option disabled="disabled" selected="selected" ><?php echo $idcard;?></option>
